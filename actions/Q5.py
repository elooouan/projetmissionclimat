...
class Window(tk.Toplevel):
    ...
    def extract_data(self):
        ...
        # On passe de 678 requetes a une seule requete
        try:
            query = """
        ...
        tab = [list(row) for row in result]

        # On les insert dans tkinter
        for row in tab:
        ...
        self.timelabel.configure(
            text="Le calcul ("+str(len(tab))+ " lignes) a pris " + str(round(end - start, 3)) + " secondes et exécute une seule requête."
        )
