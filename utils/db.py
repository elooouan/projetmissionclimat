...
def insertDB():
    try:
        ...
        read_csv_file(
            "data/csv/Chauffage.csv", ';',
            "insert into Chauffage (energie_avant_travaux_chauffage, energie_installee_chauffage, generateur_chauffage, type_chaudiere_chauffage) values (?, ?, ?, ?)",
        ...
        read_csv_file(
            ...
            "insert into Isolation (poste_isolation, isolant_isolation, epaisseur_isolation, surface_isolation) values (?, ?, ?, ?)",
            ['poste_isolation', 'isolant', 'epaisseur', 'surface']
        )

        # On ajoute les donnees photovoltaiques
        read_csv_file(
            "data/csv/Photovoltaique.csv", ';',
            "insert into Photovoltaique (puissance_photovoltaique, type_panneaux_photovoltaique) values (?, ?)",
